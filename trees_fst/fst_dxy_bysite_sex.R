...
slist <- list(
	...
	NorthF=which(sss=="North"&sexes[cname[10:585],3]=="F"),
	SouthM=which(sss=="South"&sexes[cname[10:585],3]=="M"),
	SouthF=which(sss=="South"&sexes[cname[10:585],3]=="F"),
	AdmixM=which(sss=="Admix"&sexes[cname[10:585],3]=="M"),
	AdmixF=which(sss=="Admix"&sexes[cname[10:585],3]=="F"),
